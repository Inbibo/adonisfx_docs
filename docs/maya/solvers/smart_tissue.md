...
<figure style="width: 75%;" markdown>
  ...
  <figcaption><b>Figure 1</b>: AdnSmartTissue Attribute Editor.</figcaption>
</figure>

<figure style="width: 75%;" markdown>
  ![smart tissue attrib editor second part](../images/smart_tissue_attribute_editor_01.png)
  <figcaption><b>Figure 2</b>: AdnSmartTissue Attribute Editor (Advanced Settings).</figcaption>
</figure>

<figure style="width: 75%;" markdown>
  ![smart tissue attrib editor debug menu](../images/smart_tissue_attribute_editor_02.png)
  <figcaption><b>Figure 3</b>: AdnSmartTissue Attribute Editor (Deformer Attributes and Debug menu)</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 4</b>: Example of painted weights on the skin of the Hyena. First row, from left to right: deformer weights and hard constraint weights. Second row, from left to right: push multiplier weights and weights flooded to 1.0 for the rest of the maps.</figcaption>
</figure>
