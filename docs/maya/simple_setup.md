...
<figure markdown>
  ![AdnMuscle custom creation UI](images/simple_setup_muscle_01.png)
...
<figure markdown>
  ![Basic setup for planar biceps simulations](images/simple_setup_ribbon_muscle_00.png)
...
<figure markdown>
  ![AdnRibbonMuscle custom creation UI](images/simple_setup_ribbon_muscle_01.png)
...
<figure markdown>
  ![Tendon weights for planar biceps](images/simple_setup_ribbon_muscle_02.png)
...
<figure markdown>
  ![Muscle fibers combing](images/simple_setup_ribbon_muscle_03.png)
...
<figure markdown>
  ![Slide on segment weights for planar biceps](images/simple_setup_ribbon_muscle_04.png)
  <figcaption><b>Figure 17</b>: Slide on segment weights for planar biceps.</figcaption>
</figure>

<figure markdown>
  ![Slide on geometry weights for planar biceps](images/simple_setup_ribbon_muscle_05.png)
...
To tweak additional parameters of the AdnRibbonMuscle deformer, check this [page](solvers/ribbon).
...
<figure markdown>
  ...
  <figcaption><b>Figure 20</b>: Debugging the Glue Constraints connections with a Max Glue Distance of 0.1.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 21</b>: Glue Distance Multiplier map painted in specific areas where muscles are supposed to be glued together.</figcaption>
</figure>

<figure markdown>
  ![Displaying the Glue Constraints debugger](images/simple_setup_glue_03.png)
  <figcaption><b>Figure 22</b>: Displaying the Glue Constraints debugger after painting the Glue Distance Multiplier in the target area.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 23</b>: Glue Resistance map painted in specific areas where muscles are supposed to be glued together.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 24</b>: Basic setup for fat simulations.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 25</b>: AdnFat deformer creation scenario.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 27</b>: Basic setup for skin simulations. The mesh on the left corresponds to the skin mesh to be simulated, while the mesh on the right corresponds to the animated target mesh.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 28</b>: AdnSkin deformer creation scenario.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 29</b>: AdnSkin weight maps. From left to right: Soft Constraints, Hard Constraints, Slide Constraints and Sliding Distance Multiplier.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 30</b>: Basic setup for AdnRelax. The mesh is the result of the fascia simulation to which AdnRelax is going to be applied. </figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 31</b>: Example of paintable weights of AdnRelax deformer applied to the fascia layer of a biped. From left to right: smooth multiplier, relax multiplier, push in ratio multiplier, push out ratio multiplier.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 33</b>: Fascia geometry result of duplicating and renaming the outer skin mesh at rest.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 35</b>: Example of Push Multiplier map of AdnPush deformer.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 37</b>: Minimum required geometries to configure an AdnSkinMerge deformer. From left to right: Animation Mesh, Simulation Mesh and Final Mesh to apply the AdnSkinMerge deformer.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 40</b>: Result of AdnSkinMerge in a specific frame. From left to right: Animation Mesh, Simulation Mesh and Final Mesh.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 41</b>: Basic setup for facial simulations. From left to right: rest mesh, deformation mesh and animation mesh.</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption><b>Figure 43</b>: Example of the attraction force map.</figcaption>
</figure>
...
- The animated geometry to apply the deformer to.

In order to use the AdnSmartTissue ML dynamic material properties predictions, you will also need:

- An `.adnm` file generated with the [Neural Training Tool](tools/neural_training_tool) trained with muscle activation data.
...
To create the AdnSmartTissue deformer it is required to select the mesh that has the skinCluster applied.

Then press the ![AdnSmartTissue button](../images/adn_smart_tissue.png){style="width:4%"} in the Adonis shelf or go to the Adonis > Solvers > *Smart Tissue*.

A simple UI will pop up to provide two optional inputs: ML Model File and Joints Info File.

<figure markdown>
  ![Creation scenario AdnSmartTissue](images/simple_setup_smart_tissue_00.png)
  <figcaption><b>Figure 47</b>: AdnSmartTissue creation scenario.</figcaption>
</figure>
...
<figure markdown>
  ![AdnSmartTissue Push](images/simple_setup_smart_tissue_01.png)
  <figcaption><b>Figure 48</b>: Smart Tissue procedural tissue simulation push.</figcaption>
</figure>
...
> [!NOTE]
> AdnSmartTissue requires the use of the Maya Paint tool (not the Adonis paint tool) for the paintable weights setup.

Start by painting the *weights* to remove the limb extremities and head from the procedural tissue simulation.

<figure markdown>
  ![AdnSmartTissue Global Weights Map](images/simple_setup_smart_tissue_02.png)
  <figcaption><b>Figure 49</b>: Smart Tissue procedural tissue simulation global weights map painting.</figcaption>
</figure>
...
You can debug the ML material properties prediction by pressing the ![AdnSmartTissue Activation Debugger button](images/adn_smart_tissue_activation_debugger.png){style="width:4%"} in the Adonis shelf or go to the Adonis > Smart Tissue > *Activation Debugger*.
