...
| :-------------- | :----------- | :------- | :--- | :------ | :---------- |
| `in_filepath` | `--input-data`, `-i` | Yes | string |  | Path to the input data `.csv` file used for training. |
| `out_filepath` | `--output-data`, `-o` | Yes | string |  | Path to the output data `.csv` file used for training. |
| `model_target_path` | `--modelpath`, `-m` | Yes | string |  | Path where the trained model will be saved. The output file must use the `.adnm` extension. |
...
### Run the standalone launcher and use Python

Use this mode when the standalone runner is used to start an AdonisML Python environment.
...
The runner is located in the AdonisML package directory.

On Windows, start the runner with:

<pre><code style="white-space: pre; margin: 20px 0; padding: 10px; box-sizing: border-box;">"&lt;adnml_package_path&gt;/run.bat"
</code></pre>

On Linux, start the runner with:

<pre><code style="white-space: pre; margin: 20px 0; padding: 10px; box-sizing: border-box;">"&lt;adnml_package_path&gt;/run.sh"
</code></pre>

From the AdonisML Python environment, call the `train` function directly:
...
### Run the standalone launcher with command-line arguments
