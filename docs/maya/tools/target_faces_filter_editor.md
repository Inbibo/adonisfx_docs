...
2. The user must provide a valid selection before launching the tool and/or clicking the Select button to start. This selection can be the geometry with the solver applied or the solver itself.
