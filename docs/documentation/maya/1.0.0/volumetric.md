...
| Type         | Float                                                             |
| Default Value| 0.0                                                               |
| Description  | Current activation of the deformed volumetric muscle.<br/>The activation modifies the stiffness of the muscle depending<br/>on the fibers direction of the muscle.<br/><br/>Has a range of \[0.0, 1.0\] [^1]|
...
<figure markdown>
  ![volumetric muscle editor debug menu](../../../images/attribute_editor_ribbon_debug.png)
  <figcaption>Figure 4: Volumetric Muscle Attribute Editor (Debug menu)</figcaption>
</figure>

To enable the debugger the *Debug* checkbox must be marked. To select the specific feature you would like to visualize, choose it from the list provided in *Features*. The features that can be visualized with the debugger in the Volumetric Muscle deformer are:
