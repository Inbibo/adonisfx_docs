...
AdonisFX solvers interpret input units as meters. In order to simulate external forces like gravity with realism, you need to take some considerations into account:
 ...
 - It is not mandatory to use a factor of 9.8 for the gravity. AdonisFX solvers are not restrictive in this regard. Sometimes, if you aim for a different artistic, you can experiment with different values.
