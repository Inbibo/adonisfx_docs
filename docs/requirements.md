...
> - Some features require a specific Adonis license bundle. See [Licensing](licensing.md) for details. For example, FX features require an AdonisFX bundle, and ML features require an AdonisML bundle.
