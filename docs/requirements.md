...
- With an AdonisFX license, see [Licensing](licensing.md) for details, installing the ML dependencies is optional. It is only required to run ML inference on the GPU. If not installed, ML inference runs on the CPU.
