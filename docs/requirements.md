...
- With an AdonisFX license, see [Licensing](licensing#adonis-bundles) for details, installing the ML dependencies is optional. It is only required to run ML inference on the GPU. If not installed, ML inference runs on the CPU.

## AdonisML

- AdonisML features require an AdonisML license bundle. See [Licensing](licensing#adonis-bundles) for details.
