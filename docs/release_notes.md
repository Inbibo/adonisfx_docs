...
### Improvements
- Improved warnings and errors handling in mirror tool to be more verbose.
- Added paintable map in AdnSkin solver to control the influence of the self-collisions solving per vertex.
