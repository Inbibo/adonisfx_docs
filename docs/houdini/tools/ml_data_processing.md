...
- **Load Joint List From File**: Allows loading the joint list from the configuration file of a previous data extraction.
- **Joints Group**: Group selector used to select the joints that will be used for data extraction.
...
6. Select the joints to use for data extraction.
    ...
    Alternatively, enable **Load Joint List From File** to load the joint list from the configuration file of a previous data extraction.
